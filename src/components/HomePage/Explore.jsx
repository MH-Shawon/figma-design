          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div className="mb-8 lg:w-2/3 lg:pr-8 lg:mb-0">
              ...
              <p className="mt-4 text-base text-white sm:text-lg font-baiJamjuree">
                ...
                individuals with their dreams. Anchored in our core values and
                driven by a vision to empower people to become successful
                business owners, we are committed to turning this vision into
                reality for as many people as we can.
              </p>
