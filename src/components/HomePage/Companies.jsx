...
const Companies=()=>{
    return(
        <div className="py-8 text-center bg-[#F4F6F6] p-5 p-x-240.28 p-b-55.016 p-x-240">
            ...
            <div className="flex justify-center mt-6 space-x-24 ">
                ...
                <Image src="/assets/companies/Entrepreneur.svg" alt="Entrepreneur Logo" width={120.377} height={24.993} className="fill-gray-500" />
