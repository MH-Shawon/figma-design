...
const Swiper2 = () => {
  return (
    <div className="mt-12 text-blue-500">
      <Swiper
        direction={"vertical"}
        pagination={{
          clickable: true,
      ...
      >
        ...
        <SwiperSlide className="flex items-center justify-center h-full text-2xl text-white bg-blue-500">
          Slide 2
        </SwiperSlide>
        <SwiperSlide className="flex items-center justify-center h-full text-2xl text-white bg-green-500">
          Slide 3
        </SwiperSlide>
        <SwiperSlide className="flex items-center justify-center h-full text-2xl text-white bg-yellow-500">
          Slide 4
        </SwiperSlide>
        <SwiperSlide className="flex items-center justify-center h-full text-2xl text-white bg-purple-500">
          Slide 5
        </SwiperSlide>
        <SwiperSlide className="flex items-center justify-center h-full text-2xl text-white bg-pink-500">
          Slide 6
        </SwiperSlide>
        <SwiperSlide className="flex items-center justify-center h-full text-2xl text-white bg-teal-500">
          Slide 7
        </SwiperSlide>
        <SwiperSlide className="flex items-center justify-center h-full text-2xl text-white bg-indigo-500">
          Slide 8
        </SwiperSlide>
        <SwiperSlide className="flex items-center justify-center h-full text-2xl text-white bg-gray-500">
          Slide 9
        </SwiperSlide>
      </Swiper>
    </div>
